...
<Slider bind:slide1 bind:slide2 bind:slide3>

<header class="slide-hero" style="background-image: url(./img/hdr/bg-lotr.jpg);">
 <div class="py-4 px-4">
...
<article slot="s2" class="container-lg py-4">
  <div class="mb-2">
    <button type="button" class="btn btn-light" on:click={changeSlide(slide1)}><Fa icon={faChevronLeft} /></button>
  </div>
  ...
  <div class="row g-2">
    <div class="col">
      ...
      <div class="px-2 text-start">
        ...
        <div class="py-4">
          <button type="button" class="btn btn-info btn-lg" on:click={changeSlide(slide3)}>
            <Fa icon={faMicrophone} fw /> Hoerspiele
          </button>
        </div>
      </div>
    </div>
...
<article slot="s3" class="container-lg py-4">
  <div class="mb-2">
    <button type="button" class="btn btn-light" on:click={changeSlide(slide2)}><Fa icon={faChevronLeft} /></button>
  </div>
...
<style lang="scss" global>
  ...
  :global(.img-list) {
    ...
    width: 100%;
    height: 100%;
    max-width: $card-imge-width;
    max-height: $card-imge-height;
    object-fit: cover;
  }
  .slide-hero {
